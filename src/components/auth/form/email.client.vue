    ...
    <div class="w-full">
        ...
        <div class="flex">
            <div class="mt-2 w-full mr-5">
                <input id="email" name="email" type="email" autocomplete="email" required="" v-model="input.email"
                    :disabled="isLoading || isLoggedIn"
                    :class="{
                        'text-gray-400': isLoggedIn
                    }"
                    class="block border w-full px-2 rounded-md py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
            </div>
