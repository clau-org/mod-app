...
<template>
    <div class="w-full">
        <button @click="login" :disabled="isLoading || isLoggedIn"
            ...
            <svg v-if="!isLoading" class="h-5 w-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
            ...
            <span v-if="!isLoading" class="text-sm font-semibold leading-6">GitHub</span>
